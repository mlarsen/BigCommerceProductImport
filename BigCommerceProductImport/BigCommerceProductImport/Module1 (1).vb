...
Module Module1
    ...
    'Public stPath As String = "E:\ArchiveCustomers\Transformation Publication\Data"
    ...
    Sub BigCommerceImport(ByRef stFileName As String, ByRef stODBCString As String)
        ...
        'Create Temp Table
        stSQL = "CREATE TABLE TempBCProducts( " + _
        Chr(34) + "ItemType" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductID" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductName" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductType" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductSKU" + Chr(34) + " VARCHAR(100), " + _
        Chr(34) + "BinPickingNumber" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "BrandName" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "OptionSet" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "OptionSetAlign" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductDescription" + Chr(34) + " VARCHAR(512), " + _
        Chr(34) + "Price" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "CostPrice" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "RetailPrice" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "SalePrice" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "FixedShippingCost" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "FreeShipping" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductWarranty" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductWeight" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductWidth" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductHeight" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductDepth" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "AllowPurchases?" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductVisible?" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductAvailability" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "TrackInventory" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "CurrentStockLevel" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "LowStockLevel" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "Category" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID1" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile1" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription1" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail1" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort1" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID2" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile2" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription2" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail2" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort2" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID3" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile3" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription3" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail3" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort3" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID4" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile4" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription4" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail4" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort4" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID5" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile5" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription5" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail5" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort5" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID6" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile6" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription6" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail6" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort6" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID7" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile7" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription7" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail7" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort7" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID8" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile8" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription8" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail8" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort8" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID9" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile9" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription9" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail9" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort9" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID10" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile10" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription10" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail10" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort10" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID11" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile11" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription11" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail11" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort11" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID12" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile12" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription12" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail12" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort12" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID13" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile13" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription13" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail13" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort13" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID14" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile14" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription14" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail14" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort14" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID15" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile15" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription15" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail15" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort15" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID16" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile16" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription16" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail16" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort16" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID17" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile17" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription17" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail17" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort17" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID18" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile18" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription18" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail18" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort18" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID19" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile19" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription19" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail19" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort19" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID20" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile20" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription20" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail20" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort20" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID21" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile21" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription21" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail21" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort21" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID22" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile22" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription22" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail22" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort22" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID23" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile23" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription23" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail23" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort23" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID24" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile24" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription24" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail24" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort24" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID25" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile25" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription25" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail25" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort25" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID26" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile26" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription26" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail26" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort26" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID27" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile27" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription27" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail27" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort27" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID28" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile28" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription28" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail28" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort28" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageID29" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageFile29" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageDescription29" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageIsThumbnail29" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductImageSort29" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "SearchKeywords" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "PageTitle" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "MetaKeywords" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "MetaDescription" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "MYOBAssetAcct" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "MYOBIncomeAcct" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "MYOBExpenseAcct" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductCondition" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "EventDateRequired?" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "EventDateName" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "EventDateIsLimited?" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "EventDateStartDate" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "EventDateEndDate" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "SortOrder" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductTaxClass" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductUPC/EAN" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "StopProcessingRules" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "ProductURL" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "RedirectOldURL?" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSGlobalTradeItemNumber" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSManufacturerPartNumber" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSGender" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSAgeGroup" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSColor" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSSize" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSMaterial" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSPattern" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSItemGroupID" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSCategory" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "GPSEnabled" + Chr(34) + " VARCHAR(50), " + _
        Chr(34) + "AvalaraProductTaxCode" + Chr(34) + " VARCHAR(50), " + _
        ...
        Do While iRowID <= iMaxRowID
            'Get the core data
            stSQL = "SELECT ProductType, ProductName,BinPickingNumber,BrandName,ProductDescription,Price,CostPrice,RetailPrice,SalePrice,FixedShippingCost,ProductWeight,ProductWidth,ProductHeight,ProductDepth,CurrentStockLevel,ProductImageFile1,ProductImageFile2 INTO Temp FROM TempBCProducts WHERE RowID=" + CStr(iRowID) + ";"
            SQLTextQuery("S", stSQL, stODBCString, 17)
            ...
            Else 'Update the sub product fields
                ...
                stSQL = stSQL + "MasterCode=IF(MasterCode='',UPPER(LEFT(ProductSKU,POS('-' IN ProductSKU)-1)),MasterCode),"
                ...
                stSQL = stSQL + "Price='" + stMasterProduct(5) + "',"
                stSQL = stSQL + "CostPrice='" + stMasterProduct(6) + "',"
                stSQL = stSQL + "RetailPrice='" + stMasterProduct(7) + "',"
                stSQL = stSQL + "SalePrice='" + stMasterProduct(8) + "',"
                stSQL = stSQL + "FixedShippingCost='" + stMasterProduct(9) + "',"
                stSQL = stSQL + "ProductWeight='" + stMasterProduct(10) + "',"
                stSQL = stSQL + "ProductWidth='" + stMasterProduct(11) + "',"
                stSQL = stSQL + "ProductHeight='" + stMasterProduct(12) + "',"
                stSQL = stSQL + "ProductDepth='" + stMasterProduct(13) + "',"
                stSQL = stSQL + "ProductImageFile1='" + stMasterProduct(15) + "',"
                stSQL = stSQL + "ProductImageFile2='" + stMasterProduct(16) + "' WHERE RowID=" + CStr(iRowID) + ";"
